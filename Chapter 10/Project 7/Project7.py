...
class MyApp(ShowBase):
    def __init__(self):
        ...
        self.Spacestation = TheISSIGuess(self.loader, "./Assets/SpaceStation/spaceStation.x", self.render, "Space Station", "./Assets/SpaceStation/SpaceStation1_Dif2.png", (10000, 5000, 1000), 300)
        ...
        self.drawRockRing(self.Sun, "Rock", 40, 13)
        ...
        self.DrawCircleXDefense(self.Planet2, "CircleX", fullCycle, 2)
        self.DrawCircleYDefense(self.Planet3, "CircleY", fullCycle, 2)
    ...
    def DrawBaseballSeams(self, centralObject, groupName, numDrones, radius = 1):
         for i in range(numDrones):
              ...
              Drone(self.loader, "./Assets/DroneDefender/DroneDefender.obj", self.render, droneName, "./Assets/DroneDefender/octotoad1_auv.png", centralObject.modelNode.getPos() + relPos, 5)

    def DrawCloudDefense(self, centralObject, groupName, numDrones):
         pivot = self.render.attachNewNode(groupName + "-pivot")
...
class Player(SphereCollideObject, DirectObject):
     ...
     def HandleInto(self, entry):
           ...
           if (strippedString == "Drone" or strippedString == "Planet" or strippedString == "Space Station" or strippedString == 'Rock'):
